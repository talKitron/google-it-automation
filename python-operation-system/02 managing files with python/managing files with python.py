...
file = open("google-it-automation/python-operation-system/02 managing files with python files with python/spider.txt")
...
with open("google-it-automation/python-operation-system/02 managing files with python files with python/spider.txt") as file:
    print(file.readline())
...
with open("google-it-automation/python-operation-system/02 managing files with python files with python/novel.txt", "w") as file:
...
os.remove("google-it-automation/python-operation-system/02 managing files with python files with python/novel.txt")
...
os.rename("google-it-automation/python-operation-system/02 managing files with python files with python/spider.txt", "google-it-automation/python-operation-system/02 managing files with python files with python/spider_rename.txt")
os.rename("google-it-automation/python-operation-system/02 managing files with python files with python/spider_rename.txt", "google-it-automation/python-operation-system/02 managing files with python files with python/spider.txt")

# the OS path sub-module's exists function checks whether a file exist
print(os.path.exists("google-it-automation/python-operation-system/02 managing files with python files with python/spider_rename.txt"))

# getsize checks a file size and returns the file size in bytes
print(os.path.getsize("google-it-automation/python-operation-system/02 managing files with python files with python/spider.txt"))

# getmitime checks when the file was last modified and returns Unix timestamp
print(os.path.getmtime("google-it-automation/python-operation-system/02 managing files with python files with python/spider.txt"))

# datetime module provides a function to convert the Unix timestamp
import datetime
timestap = os.path.getmtime("google-it-automation/python-operation-system/02 managing files with python files with python/spider.txt")
...
os.mkdir("google-it-automation/python-operation-system/02 managing files with python files with python/new_dir")

# chdir function changes a directory
os.chdir("google-it-automation/python-operation-system/02 managing files with python files with python/new_dir")
print(os.getcwd())
os.chdir("..")
print(os.getcwd())
...
print(os.listdir("02 managing files with python files with python"))
dir = "02 managing files with python files with python"
os.mkdir("02 managing files with python files with python/another_new_dir")
...
os.rmdir("02 managing files with python files with python/another_new_dir")

# Reading CSV Files
import csv
f = open("02 managing files with python files with python/csv_file.txt")
...
with open ("02 managing files with python files with python/software.csv") as software:
...
with open("02 managing files with python files with python/by_department.csv", "w") as by_department:
    writer = csv.DictWriter(by_department, fieldnames=keys)
    writer.writeheader()
    writer.writerows(users)

os.remove("02 managing files with python files with python/by_department.csv")